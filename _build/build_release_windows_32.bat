...
set PROJECT_BINARY=project_release_windows_32.exe

@rem Optimized build.
set PROJECT_COMPILE=%PROJECT_COMPILE% /arch:SSE2 /favor:blend /fp:fast /O2
...
%PROJECT_COMPILE% %PROJECT_INCLUDES% /Fo_build\obj\project_release_windows_32.obj _build\unity.cc
%PROJECT_LINK% /out:_build\bin\%PROJECT_BINARY% _build\obj\project_release_windows_32.obj %PROJECT_LIBRARIES%
